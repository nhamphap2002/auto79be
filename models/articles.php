 ...
 * @since  1.6
 */
class Auto79ModelArticles extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_auto79.articles';
	...
	/**
	 * Method to duplicate an Articles
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__auto79_articles');
				$max             = $db->loadResult();
