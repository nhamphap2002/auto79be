 ...
 * @since  1.6
 */
class Auto79ViewElements extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Auto79Helper::addSubmenu('elements');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_AUTO79_TITLE_ELEMENTS'), 'elements.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_auto79&view=elements');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_AUTO79_ELEMENTS_TITLE'),
		);
	}
