...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_auto79&task=elements.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_auto79&view=elements'); ?>" method="post"
			...
			<table class="table table-striped" id="elementList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_AUTO79_ELEMENTS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_AUTO79_ELEMENTS_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'elements.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_auto79&task=element.edit&id='.(int) $item->id); ?>">
