...
class Auto79ViewLinks extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_AUTO79_TITLE_LINKS'), 'links.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('links.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_auto79&view=links');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`link`' => JText::_('COM_AUTO79_LINKS_LINK'),
			'a.`title`' => JText::_('COM_AUTO79_LINKS_TITLE'),
		);
	}
