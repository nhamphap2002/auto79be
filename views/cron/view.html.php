...
class Auto79ViewCron extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_AUTO79_TITLE_CRON'), 'cron.png');
		...
		{
			JToolBarHelper::custom('cron.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		}
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_auto79.cron', $this->item->id);
		}
