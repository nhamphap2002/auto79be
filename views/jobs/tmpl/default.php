...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_auto79&task=jobs.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_auto79&view=jobs'); ?>" method="post"
            ...
            <table class="table table-striped" id="jobList">
                <thead>
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'COM_AUTO79_JOBS_ID', 'a.`id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'COM_AUTO79_JOBS_LINK', 'a.`link`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'Tiêu đề', 'a.`category_id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'COM_AUTO79_JOBS_PROVINCE', 'a.`province`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'COM_AUTO79_JOBS_TIMEAPPROVAL', 'a.`timeapproval`', $listDirn, $listOrder); ?>
                        </th>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                ...
                                if ($item->postid != '') {
                                    ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_job79&view=jobs&layout=edit&id=' . $item->jobid); ?>" target="_blank">
