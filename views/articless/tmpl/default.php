            ...
            <table class="table table-striped" id="articlesList">
                <thead>
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo JHtml::_('searchtools.sort', 'Thởi gian được kích hoạt', 'a.`timeapproval`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                ...
                <tbody>
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                <?php echo Auto79Helper::formatDate($item->timeapproval,'d-m-Y H:i:s'); ?>
                            </td>
                            <td>
